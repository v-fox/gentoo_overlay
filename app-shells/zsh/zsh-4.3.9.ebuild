...
#		doman  zsh-lovers.1 || die "doman zsh-lovers failed"
		...
		docinto zsh-lovers
		dodoc zsh-lovers.1.txt zsh.vim README
...
pkg_postinst() {
	...
	elog "to your ~/.zshrc"
	elog
	elog "If you have a custom prompt, you probably want to add the following"
	elog "to your ~/.zshrc to reenable colors:"
	elog "    autoload colors zsh/terminfo"
	elog '    if [[ "$terminfo[colors]" -ge 8 ]]; then'
	elog "        colors"
	elog "    fi"
	elog
}
