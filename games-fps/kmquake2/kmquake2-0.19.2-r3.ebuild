...
MY_PN="quake2"
SRC_BASENAME="KMQuake2-SDL-${PV}_src_unix"
DATA_BASENAME="KMQuake2_data-0.19"
...
SRC_URI="https://github.com/downloads/v-fox/gentoo_overlay/${SRC_BASENAME}.tar.bz2
	 https://github.com/downloads/v-fox/gentoo_overlay/${DATA_BASENAME}.tar
	 http://www.markshan.com/knightmare/downloads/kmquake2_020_lvlshots_hi.zip"

LICENSE="GPL-2"
SLOT="0"
KEYWORDS="~amd64 ~x86"
IUSE="alsa audacious cdinstall cdsound debug dedicated demo dga +hud maps +models mods opengl oss custom-cflags sdl +textures"

UIRDEPEND="audacious? ( media-sound/audacious )
	dga? ( x11-libs/libXxf86dga )
	sdl? ( media-libs/libsdl )
	textures? ( >=games-fps/quake2-textures-3[kmquake2]
		hud? 	( >=games-fps/quake2-textures-3[hud] )
		models? ( >=games-fps/quake2-textures-3[models] ) )
	virtual/opengl
	virtual/glu
	x11-libs/libX11
	x11-libs/libXext
...
src_install() {
	...
	doins -r "${WORKDIR}/${DATA_STEM}"/* "${WORKDIR}"/baseq2 || die
