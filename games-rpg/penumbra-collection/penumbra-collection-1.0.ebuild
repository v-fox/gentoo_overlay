...
DESCRIPTION="Scary first-person adventure game trilogy which focuses on story, immersion and puzzles. Collection contains Overture, Black Plague and Requiem."
HOMEPAGE="http://www.penumbragame.com/"
SRC_URI="${MY_PN}-${PV}.sh"

LICENSE="PENUMBRA-COLLECTION"
SLOT="0"
KEYWORDS="~amd64" # should work on x86 too
