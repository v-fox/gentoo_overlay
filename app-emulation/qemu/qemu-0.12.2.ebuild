...
SRC_URI="http://download.savannah.gnu.org/releases/qemu/${PN}-${MY_PV}.tar.gz"
...
src_configure() {
	...
	conf_opts="--disable-darwin-user --disable-bsd-user --enable-uuid --enable-nptl --enable-mixemu --enable-io-thread --disable-strip --disable-werror --disable-fdt"
