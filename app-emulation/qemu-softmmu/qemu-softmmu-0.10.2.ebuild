...
IUSE="alsa bluetooth esd tls ncurses pulseaudio +sdl vde kqemu +kvm"
RESTRICT="test"
...
src_compile() {
	...
	use tls || conf_opts="$conf_opts --disable-vnc-tls"
...
#	use fdt || conf_opts="$conf_opts --disable-fdt"
	...
	conf_opts="$conf_opts --prefix=/usr --enable-mixemu"
